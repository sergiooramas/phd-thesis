...
The method proposed in this chapter %for leveraging semantic information in artist biographies
...
\end{table}
\subsection{Evaluated approaches}\label{sec:similarity:eval_approaches} %Sergio
