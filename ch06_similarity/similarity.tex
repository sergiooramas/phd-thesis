...
\begin{figure}[!htp]
\centerline{\framebox{
\includegraphics[width=0.95\columnwidth]{ch06_similarity/pics/methodology.png}}}
...
\subsubsection{Relation graph}\label{sec:similarity:rel_graph} %Moha
...
\begin{figure}[!htp]
\centerline{
\includegraphics[width=0.95\columnwidth]{ch06_similarity/pics/EnrichedGraph1.png}}
...
\subsection{Results and discussion} %Sergio
