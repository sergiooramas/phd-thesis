...
\begin{figure}[!htp]
\centerline{
\includegraphics[width=0.95\columnwidth]{ch06_similarity_pics/EnrichedGraph2.png}}
...
\begin{figure}
    ...
    \caption{Percentage of accuracy of the different approaches. AcousticBrainz refers to the AcousticBrainz framework. NB refers to the method based on Na\"{i}ve Bayes from \cite{Hu2005}.}
