...
We carried out an intrinsic evaluation on each component of the algorithm, as well as an extrinsic evaluation which consists of a experiment on interpretation of music recommendations, where our automatically learned \textsc{MKB} is used to provide explanations to song recommendations in \textit{natural language}.
...
\begin{figure}[!htp]
\centerline{\framebox{
\includegraphics[width=6cm]{ch04_kbconstruction_pics/threshold.eps}}}
...
\begin{figure}[!htp]
\centerline{\framebox{
\includegraphics[width=6cm]{ch04_kbconstruction_pics/threshold_el.eps}}}
...
\begin{figure}[!htp]
\centerline{
\includegraphics[width=0.6\textwidth]{ch04_kbconstruction_pics/recommender.jpg}}
