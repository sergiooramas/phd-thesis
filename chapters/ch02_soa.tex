...
In \citep{Anand2007} the authors use an item ontology to infer user preferences from rating data. %The system collaboratively generates recommendations using the ontology and infers preferences during similarity computation. 
