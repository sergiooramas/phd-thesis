...
Next, we briefly explain the main methodologies used in Recommender Systems, and enumerate the available work on knowledge-based approaches.
Finally, we dig into the existing literature on Music Information Retrieval. More specifically, we first review the state-of-the-art in text-based and semantic-based approaches. Then, we focus on three specific tasks: music genre classification, artist similarity, and music recommendation.
