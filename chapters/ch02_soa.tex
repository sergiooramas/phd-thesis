...
In addition, most popular items tend to attract most of the recommendations in collaborative filtering approaches. The relation between items and popularity is tipically represented as a \textit{long tail} distribution \citep{anderson2006long} (see Figure~\ref{}). Most of the items in the catalog normally receive very few interacitons from users, so they are almost never recommended. 
