...
%In the previous sections we have explained the motivations and context of our thesis. According to that, the main goal of this thesis is to push the state of the art in music recommendation and classification by leveraging knowledge repositories and unstructured text sources, and learning novel data representations from multimodal data using deep neural networks. Although this thesis is focused on the music domain, the work we present can be easily adapted to other multimedia domains. Figure\ref{fig:intro:chapters} shows a conceptual organization of the chapters of this thesis according to the different approaches, methods, and applications.
