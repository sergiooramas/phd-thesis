...
\cleartorecto\include{ch02_soa/soa}
\cleartorecto\include{ch03_background/background}
\cleartorecto\include{ch04_kbconstruction/kbconstruction}
\cleartorecto\include{ch05_similarity/similarity}
\cleartorecto\include{ch06_graph-rec/graph-rec}
\cleartorecto\include{ch07_text-class/text-class}
\cleartorecto\include{ch08_musicology/musicology}
\cleartorecto\include{ch09_deep-learning/deep-learning}
\cleartorecto\include{ch10_cold-rec/cold-rec}
\cleartorecto\include{ch11_multimodal-class/multimodal-class}
