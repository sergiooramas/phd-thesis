...
\cleartorecto\include{ch05_musicology/musicology}
\cleartorecto\include{ch06_similarity/similarity}
\cleartorecto\include{ch07_graph-rec/graph-rec}
\cleartorecto\include{ch08_cold-rec/cold-rec}
\cleartorecto\include{ch09_multimodal-class/multimodal-class}
